...
public class ModeloTablaMisAlojamientosUsuario extends DefaultTableModel {
	...
	private List<String> titulos = Arrays.asList("Titulo","Barrio","Capacidad","Precio/Noche","Rating");
	...
	public Object getValueAt(int row, int column) {
		...
		case 1: return a.getBarrio();
		case 2: return a.getCapacidad();
		case 3: return a.getPrecioNoche();
		case 4: return a.getRating();
		default: return null;
		}
	}
}
